	...
	<div class="detail-container center-block">
		...
		<form class="boxWrapBlue form-horizontal">
			<div class="field">
				...
				<div class="content">
					<div class="item">
						<input type="text" id="title" name="title" value="${houseMessage.title }" placeholder="请输入广告词" class="inline form-control w300"/>
					</div>
				</div>
			</div>
		...
		<button id="gene" class="mg_t20 pull-right btn btn-primary">完成分享</button>
		</div>
	</div>
</div>
<script type="text/javascript">
...
<div style="position: absolute; width: 100%; display: none; top: 150px;" id="resultDiv">
	<div style="padding:20px 40px; width:500px; border-radius:5px; border:3px solid rgb(141,187,66);color:rgb(141,187,66);font-weight:bold;background-color:#fff;display:block;margin:0 auto;box-shadow:0 0 8px #aaa;">
		分享实景高清图片成功
	</div>
</div>
